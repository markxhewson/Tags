...
public class TagsMenu {
    ...
    private void setupItems(Player player) {
        ...
        this.inventory.setItem(48, GUI.createItem(Material.BIRCH_DOOR, "&aPrevious Page", Chat.color("&7Click to go to the previous page")));
        ...
        this.inventory.setItem(50, GUI.createItem(Material.BIRCH_DOOR, "&aNext Page", Chat.color("&7Click to go to the next page")));
